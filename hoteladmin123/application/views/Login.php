...
<head>
  ...
  ======================================================= -->
    ...
    <body class="login-page">
        <div class="login-box"> 
            <div class="logo">
                <a href="javascript:void(0);" style="position: center">My Admin</a> <hr> 
                <a href="<?php echo base_url('login/Resetpass_page') ;?>" style="position: center">Reset Password</a> 
            </div>
            <div class="card">
                <div class="body">
                    <?= form_open('login/check_admin');?>
